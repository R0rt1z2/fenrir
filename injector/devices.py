...
DEVICES = [
    ...
    Device(
        'chopin',
        'Redmi Note 10 Pro China / POCO X3 GT (MT6891)',
        {
            'disable_vfy_policy': PatchStage(
                ...
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Zero get_vfy_policy table entries - don\'t verify loaded images',
            ),
            'disable_vfy_policy_ro': PatchStage(
                'disable_vfy_policy_ro',
                pattern='00 00 00 00 00 00 00 00 03 00 03 00',
                replacement='00 00 00 00 00 00 00 00 00 00 00 00',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Zero boot/recovery/system get_vfy_policy entries',
            ),
            'force_green_state': PatchStage(
                'force_green_state',
                pattern='08 b5 11 4b 7b 44 1b 68 1b 68 03 2b',
                replacement='08 b5 11 4b 7b 44 1b 68 00 23 03 2b',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Force androidboot.verifiedbootstate=green',
            ),
            'force_tee_green': PatchStage(
                'force_tee_green',
                pattern='7b 44 1b 68 7f 44 1a 68 97 e8',
                replacement='7b 44 1b 68 7f 44 00 22 97 e8',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Force GREEN boot state sent to TEE (key attestation)',
            ),
            'spoof_lock_state': PatchStage(
                'spoof_lock_state',
                pattern='09 9b 3b bb 91 4a',
                replacement='09 9b 00 bf 91 4a',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Force androidboot.vbmeta.device_state=locked',
            ),
            'spoof_device_locked': PatchStage(
                'spoof_device_locked',
                pattern='22 68 03 3b 18 bf 01 23 91 42 2b 60',
                replacement='22 68 01 23 18 bf 01 23 91 42 2b 60',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Force deviceLocked=1 (locked) sent to TEE',
            ),
        },
        cert_bypass=CertBypass.OVERRIDE,
    ),
