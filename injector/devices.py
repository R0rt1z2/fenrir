...
DEVICES = [
    ...
    Device(
        ...
        'Xiaomi 14T',
        {
            'disable_vfy_policy': PatchStage(
                'disable_vfy_policy',
                pattern='e0 01 00 b4 fd 7b be a9 f3 0b 00 f9 fd 03 00 91 1b 00 00 94',
                replacement='00 00 80 52 c0 03 5f d6 f3 0b 00 f9 fd 03 00 91 1b 00 00 94',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Don\'t enforce secure boot policy',
            ),
            'force_green_state': PatchStage(
                'force_green_state',
                pattern='68 04 00 d0 00 f9 09 b9 c0 03 5f d6',
                replacement='68 04 00 d0 1f f9 09 b9 c0 03 5f d6',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Force boot state to always be set to green',
            ),
            ...
            'spoof_device_state': PatchStage(
                'spoof_device_state',
                pattern='a8 03 5c 38 49 01 00 90 29 dd 0c 91 ea 00 00 d0',
                replacement='08 00 80 52 49 01 00 90 29 dd 0c 91 ea 00 00 d0',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Force androidboot.vbmeta.device_state=locked (AVB cmdline)',
            ),
            'spoof_custom_lock_state': PatchStage(
                'spoof_custom_lock_state',
                pattern='fd 7b be a9 f4 4f 01 a9 fd 03 00 91 f3 03 00 aa 83 00 00 94',
                replacement='81 00 80 d2 01 00 00 b9 00 00 80 d2 c0 03 5f d6 83 00 00 94',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Force custom_get_lock_state to always be LKS_LOCK (RoT deviceLocked=true)',
            ),
            'avb_allow_verification_error': PatchStage(
                'avb_allow_verification_error',
                pattern='e1 07 9f 1a f6 17 9f 1a 15 05 88 1a',
            ...
            'bypass_cmd_flash_control': PatchStage(
                'bypass_cmd_flash_control',
                pattern='1f 05 00 71 21 01 00 54 e0 05 00 f0',
                replacement='1f 05 00 71 09 00 00 14 e0 05 00 f0',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Allow fastboot flash while spoofed-locked',
            ),
            'bypass_cmd_erase_lock_control': PatchStage(
                'bypass_cmd_erase_lock_control',
                pattern='1f 05 00 71 81 00 00 54 40 05 00 b0',
                replacement='1f 05 00 71 04 00 00 14 40 05 00 b0',
                partition='lk',
                match_mode=MatchMode.ALL,
                description='Allow fastboot erase while spoofed-locked',
            ),
        },
        cert_bypass=CertBypass.OVERRIDE,
    ),
